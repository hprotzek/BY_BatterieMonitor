...
class BatterieMonitor extends IPSModule
{
    ...
    private function ReadBatteryStates()
    {
		...
		private function HTMLausgabeGenerieren($BatterienAR, $AlleLeer)
		{
				...
				.bt td'.$this->InstanceID.' {font-family:Arial, sans-serif;font-weight:bold;font-size:'.$this->ReadPropertyString("TextSize").'px;color:#'.$TextFarbcode.';padding:1px 10px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;}
